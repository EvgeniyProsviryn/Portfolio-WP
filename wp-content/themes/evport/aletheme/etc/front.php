...
function ale_enqueue_styles() {
	...
	wp_register_style( 'bootstrap_css', THEME_URL . '/css/bootstrap.min.css', array(), ALETHEME_THEME_VERSION, 'all');
    ...
    wp_register_style( 'scrollbar_css', THEME_URL . '/css/jquery.mCustomScrollbar.css', array(), ALETHEME_THEME_VERSION, 'all');

    wp_register_style( 'fontawesome_css', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css', array(), ALETHEME_THEME_VERSION, 'all');
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'scrollbar_js', THEME_URL . '/js/jquery.mCustomScrollbar.concat.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'bootstrap_js', THEME_URL . '/js/bootstrap.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'common_js', THEME_URL . '/js/common.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'jqu', 'https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
