...
function aletheme_get_options() {
    ...
    $options[] = array( "name" => "HTML_CSS",
                        "desc" => "html/css навыки в %",
                        "id" => "ale_html",
                        "std" => "",
                        "type" => "text");

    $options[] = array( "name" => "js",
                        "desc" => "js навыки в %",
                        "id" => "ale_js",
                        "std" => "",
                        "type" => "text");

    $options[] = array( "name" => "php",
                        "desc" => "php навыки в %",
                        "id" => "ale_php",
                        "std" => "",
                        "type" => "text");

    $options[] = array( "name" => "photoshop",
                        "desc" => "photoshop навыки в %",
                        "id" => "ale_photoshop",
                        "std" => "",
                        "type" => "text");

    $options[] = array( "name" => "Illustrator",
                        "desc" => "illustrator навыки в %",
                        "id" => "ale_illustrator",
                        "std" => "",
                        "type" => "text");

    $options[] = array( "name" => "gimp",
                        "desc" => "gimp навыки в %",
                        "id" => "ale_gimp",
                        "std" => "",
                        "type" => "text");
    ...
    $options[] = array( 'name' => "H1 Style",
                        ...
                        'id' => 'ale_h1sty',
                        'std' => array('size' => '22px','face' => 'PT+Sans+Narrow','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H2 Style",
                        'desc' => "Change the h2 style",
                        'id' => 'ale_h2sty',
                        'std' => array('size' => '20px','face' => 'PT+Sans+Narrow','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H3 Style",
                        'desc' => "Change the h3 style",
                        'id' => 'ale_h3sty',
                        'std' => array('size' => '18px','face' => 'PT+Sans+Narrow','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H4 Style",
                        'desc' => "Change the h4 style",
                        'id' => 'ale_h4sty',
                        'std' => array('size' => '16px','face' => 'PT+Sans+Narrow','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H5 Style",
                        'desc' => "Change the h5 style",
                        'id' => 'ale_h5sty',
                        'std' => array('size' => '14px','face' => 'PT+Sans+Narrow','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H6 Style",
                        'desc' => "Change the h6 style",
                        'id' => 'ale_h6sty',
                        'std' => array('size' => '12px','face' => 'PT+Sans+Narrow','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "Body Style",
                        'desc' => "Change the body font style",
                        'id' => 'ale_bodystyle',
                        'std' => array('size' => '11px','face' => 'PT+Sans+Narrow','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');
